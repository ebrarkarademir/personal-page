<template>
          <section
            id="projects"
            class="scroll-mt-16 md:mb-24 lg:scroll-mt-24"
                ...
                <li class="mb-12">
                  <div
                    ...
                    <div class="z-10 sm:order-2 sm:col-span-6">
                      <h3>
                        <a
                          ...
                          href="https://www.tiryakihukuk.com"
                          target="_blank"
                      ...
                      <p class="mt-2 text-sm leading-normal">
                        Appointment scheduling web app for attorneys. Users schedule Google Meet integrated online video meetings, in-person meetings, and phone calls with attorneys. Online payment integration with İyzico.
                      </p>
                      <ul
                    ...
                    <img
                      ...
                      decoding="async"
                      data-nimg="1"
                      class="rounded border-2 w-full border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                ...
                <li class="mb-12">
                  <div
                    ...
                    <div class="z-10 sm:order-2 sm:col-span-6">
                      ...
                      <p class="mt-2 text-sm leading-normal">
                        Admin panel for managing blogs, scheduled appointments, attorney working hours, exceptional hours and more. Admin and attorney roles with different permissions. Includes email service for customers and attorneys.
                      </p>
                      <ul
                        class="mt-2 flex flex-wrap"
                        aria-label="Technologies used:">
                  ...
                  <div
                    ...
                    <div class="z-10 sm:order-2 sm:col-span-6">
                      <h3>
                        <a
                          class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                          href="https://github.com/ebrarkarademir/game-ai-project"
                          target="_blank"
                          rel="noreferrer noopener"
                      ...
                      <p class="mt-2 text-sm leading-normal">
                        I developed a game for an AI to learn how to play it. The game is a simple 2D game where the AI tries to jump or slide to avoid obstacles. The AI learns how to play the game by using a NEAT genetic algorithm.
                      </p>
                      <ul
                        class="mt-2 flex flex-wrap"
                        aria-label="Technologies used:">
