<template>
  <div
    class="mb-12 scroll-mt-16 lg:mb-16 lg:py-24 lg:scroll-mt-24"
    aria-label="Selected projects">
    <header class="mb-8 lg:mb-16 text-center">
      ...
      <ul class="group/list">
        <li v-for="(item, index) in projects" :key="index" class="mb-12">
          <div
            ...
            <div class="z-10 sm:order-2 sm:col-span-2">
              <h3>
                <span
            ...
            <div
              class="relative sm:order-1 sm:col-span-6 sm:translate-y-1 rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30">
              <img
    ...
    <div class="mt-8 lg:mt-24 text-center">
      <router-link class="mt-3 text-lg text-slate-200 hover:text-teal-300 focus:text-teal-300 font-medium tracking-tight sm:text-xl" to="/">
        Go Home
      </router-link>
    </div>
  </div>
...
const nextSlide = (index) => {
  console.log(`Current Index Before: ${currentIndexes[index]}`);
  currentIndexes[index] =
    (currentIndexes[index] + 1) % projects[index].images.length;
  console.log(`Current Index After: ${currentIndexes[index]}`);
};
